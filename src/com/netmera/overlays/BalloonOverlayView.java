...
public class BalloonOverlayView<Item extends OverlayItem> extends FrameLayout {
	...
	public BalloonOverlayView(Context context, int balloonBottomOffset) {
		...
		float left = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, res.getDisplayMetrics());
		float top = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, res.getDisplayMetrics());
		float right = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 22, res.getDisplayMetrics());
		float bottom = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, res.getDisplayMetrics());
	...
	protected void setupView(Context context, final ViewGroup parent) {
		...
		backgroundlayout = (LinearLayout) v.findViewById(R.id.balloon_main_layout);
